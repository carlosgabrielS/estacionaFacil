...
import br.senai.sp.estacionamento.ListaMovimentacao;
import br.senai.sp.estacionamento.MainActivity;
import br.senai.sp.estacionamento.R;
import br.senai.sp.estacionamento.model.Movimentacao;

public class CarregarListaMovimentacoes extends AsyncTask{
    ...
    public CarregarListaMovimentacoes(Context context) {
    ...
    protected void onPostExecute(Object o) {
        ...
        ListaMovimentacao.listViewMovimentacao.setAdapter(adapter);
